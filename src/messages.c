...
char * Messages(UINT iIn1)
{
	...
	{
		iIn2 = (int) strtol(sMsg[i], (char **)NULL, 10);
		if (iIn1 == iIn2) { sOut = sMsg[i + 1]; }
	}
	return sOut;
}
...
int message(UINT msg, WPARAM wParam, LPARAM lParam, INT iClientX, INT iClientY)
{
	...
	for (int k = 0; k < NUMBER_OF_STRING; k++)
	{
		iIn2 = (int) strtol(sMsg[k], (char **)NULL, 10);
		if ((msg == iIn2) && (k % 3 == 1)) 
		{ 
			if (msg == 513) 
			{
